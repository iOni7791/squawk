    ...
    <header>
        <div class="main-header-container">
            ...
            <div class="header-title-container">
                <a href="index.php" class="white xy-center-cont">
                    <h1>
                        SQUAWK!
                    </h1>
                </a>
            ...
            <div class="header-login-container">
                <a href="login.php" class="white xy-center-cont"> 
            ...
            <section class="main-signup-container">
                <form action="register.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-text" class="row">
                        ...
                        <div>
                            <input class="form-control form-control-sm fs-1-5rem" type="text" name="firstname" value="" placeholder="Nombre o Usuario" required>
                        </div>
                    ...
                    <input class="form-control form-control-sm fs-1-5rem" placeholder="Fecha de nacimiento" type="date" name="fecha_nac" step="1" max="2002-12-31">
                    
                    <br>

                    <div class="center-text">
                        <input type="checkbox" name="acepta" value="s" checked required> <span class="fs-1-5rem white">Acepto los <a class="white" href="terms.php">Términos y Condiciones</a></span>
                        <br> <br>
                        <button class="fs-1-5rem" type="submit">Registro</button>
                    </div>
        ...
        <div class="main-footer-container">
            <nav class="barra-navegacion">
                <ul>
                    ...
                    <li>
                        <a class="active white fs-1-5rem  border-black" href="register.php" alt="El Nido"> Registro <br>
                    ...
                    <li>
                        <a class="white fs-1-5rem border-black" href="friends.php"> Amigos <br>
                          <span title="Busca a tus amigos buitres">
                    ...
                    <li>
                        <a class="white fs-1-5rem border-black" href="profile.php"  alt="Perfil"> Inicio <br>
                    ...
                    <li>
                        <a class="white fs-1-5rem border-black" href="faq.php">
                    ...
                    <li>
                        <a class="white fs-1-5rem border-black" href="contacto.php">
