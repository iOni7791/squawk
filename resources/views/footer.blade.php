        ...
        <div class="main-footer-container">
            <nav class="barra-navegacion">
                <ul>
                    @guest
                    <li>
                        <a class="{{ $active == 1 ? "active":"" }} fs-1-5rem border-black" href="/"> Inicio <br>
                    ...
                    <li>
                        <a class="{{ $active == 2 ? "active":"" }} fs-1-5rem border-black" href="login"> Ingreso <br>
                    ...
                    <li>
                        <a class="{{ $active == 3 ? "active":"" }} fs-1-5rem border-black" href="register"> Registro <br>
                    ...
                    <li>
                        <a class="{{ $active == 4 ? "active":"" }} fs-1-5rem border-black" href="faq">
                    ...
                    <li>
                        <a class="{{ $active == 5 ? "active":"" }} fs-1-5rem border-black" href="contact">
